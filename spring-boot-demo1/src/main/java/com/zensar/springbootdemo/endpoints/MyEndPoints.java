...
public class MyEndPoints {
	...
	@PostConstruct
	public void init() {
		bugFixesByVersion.put("v1", Arrays.asList("Invalid status issue", "Application closing not working"));
		bugFixesByVersion.put("v2", Arrays.asList("Window size change not working", "Window minimizing not working"));
